...
export default function EditProfile() {
  ...
  const handleSubmit = async () => {
    ...
    if (response) {
      ...
      setTextAlert(
        'Erro ao alterar as informações, por favor tente novamente e verifique se os dados são válidos',
      )
      setModal(true)
    }
  }
  ...
  return (
    <div className="flex flex-col gap-4 w-2/5">
      ...
      <div className="flex gap-4 w-full">
        ...
        />
        <button
          className="text-lg font-medium py-2 px-3.5 bg-gray-500 rounded-xl"
      ...
      <button
        className="text-xl font-medium py-2 px-3.5 bg-green-500 rounded-xl w-4/12"
