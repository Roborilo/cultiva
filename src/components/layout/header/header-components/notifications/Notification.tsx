	...
	return (
        ...
        sideOffset={5}>        
					<div className="flex flex-col">
						<p className="text-mauve12 text-[16px] leading-[19px] font-semibold mb-2.5">Notificações</p>
						<p className="text-mauve12 text-[16px] leading-[19px] font-semibold my-6">Nenhuma notificação no momento.</p>
					</div>
					<Popover.Close
