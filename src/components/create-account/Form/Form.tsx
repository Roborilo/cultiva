...
const resolver: Resolver<FormValues> = async (values) => {
  ...
  if (!values.name) {
    ...
    if (
      ...
      errors.name = {
        type: 'invalid',
        message: 'Name is invalid. Must only contain letters and spaces.',
      }
    }
  }
    ...
    >
      ...
      <div className="flex justify-between items-center mt-2">
        <Link
          ...
          className="text-2xl py-3 px-12 bg-gray-600 text-white rounded-md hover:bg-gray-500"
        >
          Já tenho uma conta
        </Link>
        <button
          type="submit"
          className="text-2xl py-3 px-12 bg-green-600 text-white rounded-md hover:bg-green-500"
        >
          Criar
        </button>
      </div>
