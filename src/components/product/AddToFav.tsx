...
export default function AddToFav() {
  ...
  return (
    <button
      className="focus:outline-none text-black bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-50 font-medium rounded-lg text-xl px-3.5 py-3.5 me-2 mb-2"
      onClick={handleClick}
    >
